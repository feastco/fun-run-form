      ...
      {isLoading ? (
        <div className="space-y-8 animate-pulse">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-[126px] bg-white border border-gray-100 rounded-xl"></div>
            ))}
          </div>
              ...
              <div className="flex-grow overflow-x-auto">
                {data!.recentRegistrations.length === 0 ? (
                  ...
                  <table className="w-full min-w-[600px] text-left text-sm border-collapse">
                    <thead>
                      <tr className="border-b border-gray-100 text-text-secondary font-semibold whitespace-nowrap">
