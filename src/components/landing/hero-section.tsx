  ...
  return (
    <div className="bg-secondary text-white rounded-card overflow-hidden shadow-elevated mb-12">
      <div className="px-6 py-16 md:px-12 md:py-20 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start justify-center gap-4 sm:gap-8 text-[14px] text-gray-400 mb-10 max-w-xl mx-auto">
          {eventDate && (
        ...
        <Link href="/daftar" passHref>
          <Button variant="primary" className="px-8 h-[48px] text-[16px] uppercase tracking-wider flex items-center justify-center gap-2">
            Daftar Sekarang
